$(document).ready(function () {
  ...
  // Filter Stories according to click
  var storyNumber = 10;

  // Displays articles not clicked on below current article
  ...
  // switch statement to switch stories. 
  function filterStory() {
    // Pass in the storyNumber to adjust stories listed below
    switch (storyNumber) {
      case 0:
        loadStory();
  ...
  //Contact me form using Email.js
  var emailInvite = {
  ...
  $("#sendEmail").on("click", function () {
    ...
    //sends email or throws err, notifies user if successfull or fails. 
